/* PrismJS 1.25.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+apacheconf+apex+http+hpkp+hsts+json+markup-templating+mongodb+nginx+php+python+sql+typescript+xml-doc&plugins=toolbar+copy-to-clipboard */
var _self =
                    ...
                    for (
                      ...
                      if (!(b instanceof W)) {
                        var k,
                          x = 1;
                        if (h) {
                          if (!(k = z(v, y, n, f)) || k.index >= n.length)
                            break;
                          var w = k.index,
